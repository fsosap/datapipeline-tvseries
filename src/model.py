...
def orchestrate(df:pd.DataFrame):
    ...
    # create many to many tables and load them as parquet files
    ...
    # fill many to many crossed tables
    fill_m2m_table(df)

    # create canonical tables and load them as parquet files
